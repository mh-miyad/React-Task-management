...
const TaskBar = ({ title }) => {
  ...
  return (
    <>
      <div
        className={`bg-white/5 backdrop-blur-lg dark:bg-transparent dark:backdrop-blur-md border p-4 border-indigo-600/30 rounded-lg  mx-auto w-full  sm:max-w-xs 2xl:max-w-sm mt-4`}>
